...
APP = function(global, rootView) {
    ...
    methods: {
        ...
        initialize: function(elID, data, keep) {
            this.eventDispatcher = APP.EventDispatcher, this.containerEl = $(elID), this.data = data, 
            this.isKeepOpen = keep ? !0 : !1, this.render();
        },
        render: function() {
            var i = 0, len = this.data.length;
            for (this.children = [], this.barEl = $("<ul></ul>"); len > i; i++) {
                var menuobj = ObjectUtils.basicFactory(APP.AppView.DDMenuBarView.DDMenuView);
                menuobj.initialize(this.data[i], this.isKeepOpen), $(this.barEl).append(menuobj.element), 
                this.children.push(menuobj);
            }
            this.containerEl.prepend(this.barEl), APP.globals().isIE && (this.containerEl[0].onselectstart = function() {
                return !1;
            });
        },
    ...
    methods: {
        ...
        render: function() {
            ...
            this.element = $(this.renderedHTML), this.ddMenuEl = $(this.element).find("ul"), 
            this.anchorElement = $(this.element).find("button")[0], this.data.items.forEach(this.buildMenuItems.bind(this)), 
            this.fadeOutComplete = !0, this.isKeepOpen ? this.visible = !0 : (this.visible = !1, 
            this.ddMenuEl.height("0px"), TweenMax.to(this.ddMenuEl, 0, {
                autoAlpha: 0
            }));
        },
        buildMenuItems: function(item) {
            var menuitem = ObjectUtils.basicFactory(APP.AppView.BasicMenuItemView);
            menuitem.initialize(item), this.ddMenuEl.append(menuitem.element), this.items.push(menuitem);
        },
        configureStreams: function() {
            this.menuOverStream = Rx.Observable.fromEvent(this.element[0], "mouseover").filter(this.filterForMouseEventsOnItems.bind(this)).map(this.getMouseEventTargetValue.bind(this)).subscribe(this.handleMenuOver.bind(this)), 
            this.menuOutStream = Rx.Observable.fromEvent(this.element[0], "mouseout").filter(this.filterForMouseEventsOnItems.bind(this)).map(this.getMouseEventTargetValue.bind(this)).subscribe(this.handleMenuOut.bind(this)), 
            this.menuClickStream = Rx.Observable.fromEvent(this.element[0], "click").filter(this.filterForMouseEventsOnItems.bind(this)).map(this.getMouseEventTargetValue.bind(this)).subscribe(this.handleMenuClick.bind(this));
        },
        ...
        configureMobileStreams: function() {
            ...
            }.bind(this), !1), this.element[0].addEventListener("touchmove", function(evt) {
            ...
            this.menuClickStream = Rx.Observable.fromEvent(this.element[0], "touchend").filter(this.processTouchEndEventsOnItems.bind(this)).map(this.getMouseEventTargetValue.bind(this)).subscribe(touchPressFunction.bind(this));
        },
        ...
        open: function() {
            ...
            this.ddMenuEl.height("auto"), TweenMax.killTweensOf(this.anchorElement), TweenMax.killTweensOf(this.ddMenuEl), 
        ...
        closeComplete: function() {
            this.ddMenuEl.height("0px"), this.fadeOutComplete = !0;
        }
    },
    closures: []
    ...
    methods: {
        ...
        render: function() {
            ...
            this.renderedHTML = this.template(this.data), this.element = $(this.renderedHTML), 
            this.iconElement = this.element.find("i"), this.anchorElement = this.element.find("a");
        },
        select: function() {
            this.selected || void 0 === this.element || (this.selected = !0, this.toggle && (this.iconElement.removeClass(this.iconDeselectedClass), 
        ...
        showOverEffect: function() {
            TweenMax.to(this.element, .25, {
                ...
                ease: Circ.easeOut
            }), TweenMax.to(this.anchorElement, .15, {
                boxShadow: "0px 0px 20px rgba(255,255,255,.25)",
                ease: Circ.easeOut
            });
        },
        showOutEffect: function() {
            TweenMax.killTweensOf(this.anchorElement), TweenMax.to(this.element, .5, {
        ...
        deselect: function() {
            this.selected && void 0 !== this.element && (this.selected = !1, this.toggle && (this.iconElement.removeClass(this.iconSelectedClass), 
