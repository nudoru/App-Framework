...
APP = function(global, rootView) {
    ...
    function initialize() {
        _self = this, _filterProperties = [ {
            ...
            data: [],
            menuData: []
        } ], _currentFreeTextFilter = "", _currentDataFilters = [], _currentItem = "", _eventDispatcher = APP.EventDispatcher, 
    ...
    var _eventDispatcher, _self, _dataProvider, _data, _currentFreeTextFilter, _currentDataFilters, _currentItem, _filterProperties;
    return {
        initialize: initialize,
