...
var objectDiff="undefined"!=typeof exports?exports:{};objectDiff.diff=function diff(a,b){if(a===b)return{changed:"equal",value:a};var value={},equal=!0;for(var key in a)if(key in b)if(a[key]===b[key])value[key]={changed:"equal",value:a[key]};else{var typeA=typeof a[key],typeB=typeof b[key];if(!a[key]||!b[key]||"object"!=typeA&&"function"!=typeA||"object"!=typeB&&"function"!=typeB)equal=!1,value[key]={changed:"primitive change",removed:a[key],added:b[key]};else{var valueDiff=diff(a[key],b[key]);"equal"==valueDiff.changed?value[key]={changed:"equal",value:a[key]}:(equal=!1,value[key]=valueDiff)}}else equal=!1,value[key]={changed:"removed",value:a[key]};for(key in b)key in a||(equal=!1,value[key]={changed:"added",value:b[key]});return equal?{changed:"equal",value:a}:{changed:"object change",value:value}},objectDiff.diffOwnProperties=function diffOwnProperties(a,b){if(a===b)return{changed:"equal",value:a};for(var diff={},equal=!0,keys=Object.keys(a),i=0,length=keys.length;length>i;i++){var key=keys[i];if(b.hasOwnProperty(key))if(a[key]===b[key])diff[key]={changed:"equal",value:a[key]};else{var typeA=typeof a[key],typeB=typeof b[key];if(!a[key]||!b[key]||"object"!=typeA&&"function"!=typeA||"object"!=typeB&&"function"!=typeB)equal=!1,diff[key]={changed:"primitive change",removed:a[key],added:b[key]};else{var valueDiff=diffOwnProperties(a[key],b[key]);"equal"==valueDiff.changed?diff[key]={changed:"equal",value:a[key]}:(equal=!1,diff[key]=valueDiff)}}else equal=!1,diff[key]={changed:"removed",value:a[key]}}for(keys=Object.keys(b),i=0,length=keys.length;length>i;i++)key=keys[i],a.hasOwnProperty(key)||(equal=!1,diff[key]={changed:"added",value:b[key]});return equal?{value:a,changed:"equal"}:{changed:"object change",value:diff}};

const noop=function(){};!function(){for(var method,methods=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeline","timelineEnd","timeStamp","trace","warn"],length=methods.length,console=window.console=window.console||{};length--;)method=methods[length],console[method]||(console[method]=noop)}();var autoCurry=function(){var toArray=function(arr,from){return Array.prototype.slice.call(arr,from||0)},curry=function(fn){var args=toArray(arguments,1);return function(){return fn.apply(this,args.concat(toArray(arguments)))}};return function autoCurry(fn,numArgs){return numArgs=numArgs||fn.length,function(){return arguments.length<numArgs?numArgs-arguments.length>0?autoCurry(curry.apply(this,[fn].concat(toArray(arguments))),numArgs-arguments.length):curry.apply(this,[fn].concat(toArray(arguments))):fn.apply(this,arguments)}}}();