...
APP = function(global, rootView) {
    ...
    function initGlobals() {
        ...
        _globals.mobile = {
            ...
            any: function() {
                return _globals.mobile.Android() || _globals.mobile.BlackBerry() || _globals.mobile.iOS() || _globals.mobile.Opera() || _globals.mobile.Windows() || _globals.hasTouch;
            }
    ...
    function initializeComponents() {
        ...
        _modalCoverView.initialize(), _ddMenuView = ObjectUtils.basicFactory(APP.AppView.DDMenuBarView), 
    ...
    function configureUIEvents() {
        _eventDispatcher.subscribe(APP.Events.MODAL_COVER_HIDE, hideModalContent), _eventDispatcher.subscribe(APP.Events.GRID_VIEW_LAYOUT_COMPLETE, onGridViewLayoutComplete);
    }
    ...
    function initializeMenus(data) {
        _ddMenuView.initialize("#main-navigation", data), _drawerMenuView.initialize("#drawer-navigation", data, !0);
    }
    function updateMenuSelections(data) {
        _ddMenuView.setMenuSelections(data), _drawerMenuView.setMenuSelections(data);
    }
    ...
    function clearAllFilters() {
        clearFreeTextFilter(), _ddMenuView.resetAllSelections(), _drawerMenuView.resetAllSelections(), 
    ...
    methods: {
        ...
        handleMenuClick: function(data) {
            if (this.isHeaderObject(data)) ; else {
    ...
    methods: {
        ...
        render: function() {
            var noicon = '<li><button class="dd-menu-item" data-value="<%= value %>"><%= label %></button></li>', icon = '<li class="dd-menu-item icon-left"><button class="dd-menu-item indent" data-value="<%= value %>">' + this.iconTemplate + "<%= label %></button></li>", templatehtml = noicon;
    ...
    function showItem(item) {
        ...
        _shareButtonEl = document.getElementById("details__content-share-button"), _shareButtonEl.addEventListener(APP.globals().mouseClickEvtStr, doShareAction, !1), 
    ...
    function onHashChange(evt) {
        evt.preventDefault();
        var hash = getURLHash();
        hash !== _lastSetPath && hash && _eventDispatcher.publish(APP.Events.URL_HASH_CHANGED, hash);
    }
    function getURLHash() {
    ...
    function updateURLHash(path) {
        DEBUGGER.log("Update URL: " + path), _lastSetPath = path, window.location.hash = path;
    }
...
APP.AppController.AppInitializedCommand.execute = function() {
    ...
    console.log("Initial route: " + initialRoute), void 0 !== initialRoute && this.appModel.parseFiltersFromUrl(initialRoute);
...
APP.AppController.URLHashChangedCommand.execute = function(data) {
    DEBUGGER.log("URLHashChangedCommand: " + data), void 0 !== data && (this.appModel.parseFiltersFromUrl(data), 
...
APP.AppController.ViewChangedToMobileCommand.execute = function(data) {
    DEBUGGER.log("ViewChangedToMobileCommand: " + data), this.appModel.setCurrentFreeTextFilter(""), 
