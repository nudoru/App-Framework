...
APP = function(global, rootView) {
    ...
    function initGlobals() {
        _globals = {}, _globals.isIE = -1 < navigator.userAgent.indexOf("MSIE "), _globals.isIE8 = _globals.isIE && -1 < navigator.appVersion.indexOf("MSIE 8"), 
        _globals.isIE9 = _globals.isIE && -1 < navigator.appVersion.indexOf("MSIE 9"), _globals.isFF = -1 < navigator.userAgent.indexOf("Firefox/"), 
        _globals.isChrome = -1 < navigator.userAgent.indexOf("Chrome/"), _globals.isMac = -1 < navigator.userAgent.indexOf("Macintosh;"), 
        ...
        _globals.hasTouch = "ontouchstart" in document.documentElement, _globals.mobile = {
            Android: function() {
...
APP.AppController.ViewChangedToMobileCommand.execute = function(data) {
    ...
    function preInitialize() {
        if (APP.initialize(), APP.globals().isIE) {
            var appv = navigator.appVersion;
            appv.indexOf("MSIE 6") > -1 || appv.indexOf("MSIE 7") > -1 || appv.indexOf("MSIE 8") > -1 ? alert("Your browser is not supported by this site. Please use Firefox, Chrome or Safari.") : appv.indexOf("MSIE 9") > -1;
        }
    }
    preInitialize();
}();